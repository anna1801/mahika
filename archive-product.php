    ...
    <div class="container">
      <div class="row g-4">
        <div class="col-md-3" id="sidebar">
          <div class="sidebar-card reveal">
            <?php
              ...
              if (!empty($categories) && !is_wp_error($categories)) {
                echo '<h6>Products By Category</h6>';
                echo '<div class="cat-link active" data-id="0">All</div>';
                foreach ($categories as $category) {
                  echo '<div class="cat-link" data-id="'.esc_attr($category->term_id).'">'.esc_html($category->name).'</div>';
                }
              }
            ?>
          </div>
          ...
          ?>
          <div class="sidebar-card reveal custom-style-33">
